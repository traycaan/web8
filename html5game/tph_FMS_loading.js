...
//////////////////////  Settings for TEXT //////////////////////
		...
		var text_style="20px Retro Computer";						//font style of loading text
		...
		var text_y_pos= 288;								//text vertical position: use (_height/2) to center
//////////////////////  LOADING BAR SETTINGS ////////////////////////////////	
		var barwidth = 150;					//Loading bar width in pixel, use (_width / 100) * 50 to have a bar 50% width of screen
		var barheight = 10;                          	// Loading bar height in pixel
		var x = (_width - barwidth) / 2;				// Loading bar orizizontal position (in example centered orizontally)
		var y = 300;		// Loading bar vertical position (in example moved 150px down from center)
...
///////////////////// BACKGROUND SETTINGS   ///////////////////////////////////
		var window_bgd="rgb(39,39,39)"; 				//Background color 
